...
export const AddBeneficiaryLayout = ({ shouldShowFooter = true }: Props) => {
  const { CurrentStepView } = useBeneficiaryCreationFlow();
  const navigation = useLogInNavigation();

  useStepBackOverride<BeneficiaryCreationFormFields, LogInStackParamList>(useBeneficiaryCreationFlow, navigation, false);
  useKeyboardAware();
