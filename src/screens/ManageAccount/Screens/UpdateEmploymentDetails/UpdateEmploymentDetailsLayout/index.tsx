...
import { useUpdateEmploymentDetailsFlow } from '../steps';

export const UpdateEmploymentDetailsLayout = () => {
  const {
    CurrentStepView,
    meta: { isFirstStep },
    moveToPreviousValidStep,
  } = useUpdateEmploymentDetailsFlow();
  const navigation = useLogInNavigation();
  const route = useRoute();

  useStepBackOverride<UpdateEmploymentDetailsFormFields, LogInStackParamList>(useUpdateEmploymentDetailsFlow, navigation, true);
  useKeyboardAware();
